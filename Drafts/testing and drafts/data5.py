...
df2 = pd.read_excel('december.xlsx')
# print(df2)
...
for matches in range(len(homeTeamList)):
    ...
    gameFinder = teamgamelog.TeamGameLog(team_id=homeTeam_id, season='2021-22')
    time.sleep(.600)
...
df3 = pd.read_excel('decemberpredict.xlsx')
df3 = df3.assign(winner=winnerList)
print("Predicted winners added to December spreadsheet")
